...
- `sumu-design-system` — ACTIVATE when building, editing, or designing UI pages, landing pages, technical analysis sections, or feature highlights in Barizaloka. Applies design patterns, color schemes (emerald/teal/indigo), typography hierarchy (brand-serif/mono/sans), and technical narrative structures derived from `/sumu-serikat-usaha-muhammadiyah#analisis-teknis`.
