    ...
    <section class="bg-white border-b border-[#e0ebe7] py-8">
        <div class="max-w-[1100px] mx-auto px-6 flex flex-wrap justify-center items-center">
            <div class="text-center px-10 border-r border-[#e0ebe7] max-sm:px-5">
                ...
                <div class="text-sm text-zinc-500 font-medium">Karya Digital</div>
            </div>
            <div class="text-center px-10 border-r border-[#e0ebe7] max-sm:px-5">
                <div class="font-brand-serif text-4xl font-extrabold text-brand-primary mb-1" style="font-family: 'Playfair Display', Georgia, serif;">100%</div>
                <div class="text-sm text-zinc-500 font-medium">Dedikasi Santri</div>
            </div>
            <div class="text-center px-10 border-r border-[#e0ebe7] max-sm:px-5">
    ...
    <section class="py-20 bg-white">
        <div class="max-w-[1100px] mx-auto px-6">
            <div class="relative text-center bg-brand-light rounded-2xl px-8 py-14 overflow-hidden">
                ...
                <p class="relative font-brand-serif italic font-bold text-[clamp(1.2rem,3vw,1.6rem)] text-brand-dark leading-snug max-w-2xl mx-auto mb-8" style="font-family: 'Playfair Display', Georgia, serif;">"Kami bukan sekadar pembuat website. Kami adalah pemuda desa yang ingin pesantren, desa, dan UMKM lokal punya suara di dunia digital."</p>
        ...
        <div class="max-w-[1100px] mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
                <div>
                    ...
                    <p class="text-zinc-500 mb-6">Didirikan oleh pemuda dari Kecamatan Sedan &amp; Sarang, Kabupaten Rembang, kami membangun infrastruktur digital yang berpijak pada nilai-nilai pesantren: <strong class="text-brand-primary">kolaboratif, ikhlas bermanfaat, dan berorientasi dampak nyata.</strong></p>
                ...
                <div class="grid grid-cols-2 gap-4 mt-2">
                    ...
                    <div class="bg-white border border-[#e0ebe7] rounded-xl text-center font-bold py-4">🏢 Lembaga</div>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="relative max-w-2xl mx-auto py-8">
                ...
                <div class="relative pl-12 mb-10">
                    ...
                    <div class="bg-[#FFFDF5] border border-brand-gold rounded-xl p-6 shadow-sm">
                        ...
                        <p class="text-sm text-zinc-500 leading-relaxed">Ramadan menjadi titik balik. Di bulan yang penuh refleksi ini, kami memulai kembali — kali ini dengan benar. Pondasi dibangun dari awal: visi yang jelas, nilai yang solid, dan layanan yang terstruktur. Bukan sekadar berlari, tapi tahu ke mana harus pergi.</p>
                ...
                <div class="relative pl-12">
                    ...
                    <div class="bg-white border border-brand-primary rounded-xl p-6" style="box-shadow: 0 0 15px rgba(29,158,117,.15);">
                        ...
                        <p class="text-sm text-zinc-500 leading-relaxed mb-4">Dengan pondasi yang kini kokoh, Barizaloka membuka diri untuk dunia. Kami resmi menerima jasa pembuatan website untuk pesantren, desa, dan UMKM — membawa semua nilai yang sudah kami bangun ke dalam setiap proyek.</p>
