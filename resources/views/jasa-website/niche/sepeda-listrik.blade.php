<x-layouts.base
    ...
    description="Jasa pembuatan website toko sepeda listrik mulai Rp 350.000/tahun. Tampilkan katalog produk, spesifikasi, dan kontak pemesanan agar toko Anda tampil profesional online."
>
    ...
    <section class="relative min-h-[70vh] flex items-center overflow-hidden bg-brand-darker">
        <svg class="absolute inset-0 w-full h-full opacity-15" viewBox="0 0 900 600" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
            <defs>
                <pattern id="islamicPatSepedaListrik" x="0" y="0" width="80" height="80" patternUnits="userSpaceOnUse">
            ...
            <rect width="100%" height="100%" fill="url(#islamicPatSepedaListrik)"/>
        </svg>
        ...
        <div class="relative z-10 max-w-3xl mx-auto px-6 py-16 text-center hero-anim">
            ...
            <span class="inline-flex items-center gap-1.5 bg-white/12 border border-white/25 rounded-full px-4.5 py-2 text-sm text-[#c8f0e2] tracking-wide mb-6">🚲 Untuk Toko &amp; Distributor Sepeda Listrik</span>
            ...
            <h1 class="font-brand-serif font-extrabold text-[clamp(2rem,6vw,3.6rem)] leading-[1.15] text-white mb-3" style="font-family: 'Playfair Display', Georgia, serif;">
                ...
                <span style="background: linear-gradient(135deg, #5DCAA5 0%, #a8edd4 50%, #5DCAA5 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">Katalog Rapi, Closing Lebih Cepat</span>
            </h1>

            <p class="text-lg text-white/78 max-w-xl mx-auto mb-8">Tampilkan katalog sepeda listrik, spesifikasi baterai &amp; jarak tempuh, hingga kontak pemesanan dalam satu website yang mudah diakses calon pembeli.</p>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-3xl mx-auto px-6 text-center">
            <p class="text-zinc-500 leading-relaxed">Pasar sepeda listrik tumbuh pesat, tapi calon pembeli sering ragu karena informasi spesifikasi (kapasitas baterai, jarak tempuh, garansi) hanya tersebar di caption media sosial. Website resmi membantu toko sepeda listrik tampil lebih terpercaya dan memudahkan pembeli membandingkan produk sebelum membeli.</p>
        </div>
    </section>
    ...
    <section class="py-20 bg-[#f4f8f6]">
        <div class="max-w-[1100px] mx-auto px-6">
            <div class="text-center max-w-lg mx-auto mb-12">
                ...
                <h2 class="font-brand-serif text-[clamp(1.6rem,4vw,2.4rem)] font-bold mb-3" style="font-family: 'Playfair Display', Georgia, serif;">Tantangan yang Sering Dihadapi Toko Sepeda Listrik</h2>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white border border-[#e0ebe7] rounded-2xl px-8 py-10 text-center hover:shadow-md hover:-translate-y-1 transition-all">
                    ...
                    <h4 class="font-brand-serif text-lg font-bold mb-3" style="font-family: 'Playfair Display', Georgia, serif;">Spesifikasi Produk Tidak Jelas</h4>
                    <p class="text-sm text-zinc-500 leading-relaxed">Calon pembeli kesulitan membandingkan kapasitas baterai, jarak tempuh, dan kecepatan maksimal antar model karena info hanya ada di caption Instagram.</p>
                </div>
                <div class="bg-white border border-[#e0ebe7] rounded-2xl px-8 py-10 text-center hover:shadow-md hover:-translate-y-1 transition-all">
                    <div class="text-4xl mb-4">🛠️</div>
                    <h4 class="font-brand-serif text-lg font-bold mb-3" style="font-family: 'Playfair Display', Georgia, serif;">Ragu Soal Garansi &amp; Servis</h4>
                    <p class="text-sm text-zinc-500 leading-relaxed">Tanpa halaman resmi, pembeli tidak yakin apakah toko menyediakan garansi, sparepart, dan layanan servis purna jual.</p>
                </div>
                <div class="bg-white border border-[#e0ebe7] rounded-2xl px-8 py-10 text-center hover:shadow-md hover:-translate-y-1 transition-all">
                    <div class="text-4xl mb-4">📍</div>
                    <h4 class="font-brand-serif text-lg font-bold mb-3" style="font-family: 'Playfair Display', Georgia, serif;">Sulit Ditemukan Calon Pembeli Baru</h4>
                    <p class="text-sm text-zinc-500 leading-relaxed">Toko hanya mengandalkan marketplace atau media sosial, sehingga kalah bersaing dengan kompetitor yang sudah punya website sendiri di hasil pencarian Google.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-white">
        <div class="max-w-[1100px] mx-auto px-6">
            <div class="text-center max-w-lg mx-auto mb-12">
                ...
                <h2 class="font-brand-serif text-[clamp(1.6rem,4vw,2.4rem)] font-bold mb-3" style="font-family: 'Playfair Display', Georgia, serif;">Fitur Website Toko Sepeda Listrik dari Barizaloka</h2>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="flex gap-4 bg-[#f4f8f6] border border-[#e0ebe7] rounded-2xl p-8">
                    ...
                    <div>
                        <strong class="block mb-1.5">Katalog Produk &amp; Spesifikasi Lengkap</strong>
                        <p class="text-sm text-zinc-500 leading-relaxed">Tampilkan tiap model sepeda listrik lengkap dengan foto, harga, kapasitas baterai, dan jarak tempuh.</p>
                    </div>
                </div>
                <div class="flex gap-4 bg-[#f4f8f6] border border-[#e0ebe7] rounded-2xl p-8">
                    <span class="text-2xl shrink-0">🛡️</span>
                    <div>
                        <strong class="block mb-1.5">Info Garansi &amp; Layanan Servis</strong>
                        <p class="text-sm text-zinc-500 leading-relaxed">Cantumkan ketentuan garansi, ketersediaan sparepart, dan layanan servis agar pembeli lebih percaya.</p>
                    </div>
                </div>
                <div class="flex gap-4 bg-[#f4f8f6] border border-[#e0ebe7] rounded-2xl p-8">
                    <span class="text-2xl shrink-0">💬</span>
                    <div>
                        <strong class="block mb-1.5">Pemesanan &amp; Test Ride via WhatsApp</strong>
                        <p class="text-sm text-zinc-500 leading-relaxed">Tombol pesan atau jadwalkan test ride langsung terhubung ke WhatsApp toko Anda.</p>
                    </div>
                </div>
                <div class="flex gap-4 bg-[#f4f8f6] border border-[#e0ebe7] rounded-2xl p-8">
                    <span class="text-2xl shrink-0">📈</span>
                    <div>
                        <strong class="block mb-1.5">Ditemukan Calon Pembeli di Google</strong>
                        <p class="text-sm text-zinc-500 leading-relaxed">Website dioptimasi agar toko Anda muncul saat orang mencari "sepeda listrik" di sekitar lokasi Anda.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="py-20 bg-[#f4f8f6]">
        <div class="max-w-[1100px] mx-auto px-6">
            <div class="text-center max-w-lg mx-auto mb-12">
                ...
                <h2 class="font-brand-serif text-[clamp(1.6rem,4vw,2.4rem)] font-bold mb-3" style="font-family: 'Playfair Display', Georgia, serif;">Pertanyaan Seputar Website Toko Sepeda Listrik</h2>
            </div>
    ...
    <section class="py-20 bg-[#f4f8f6] text-center">
        <div class="max-w-[1100px] mx-auto px-6">
            <h2 class="font-brand-serif text-[clamp(1.6rem,4vw,2.4rem)] font-bold mb-3" style="font-family: 'Playfair Display', Georgia, serif;">Siap Buat Website Toko Sepeda Listrik Anda?</h2>
            <p class="text-zinc-500 max-w-xl mx-auto mb-10">Konsultasi gratis via WhatsApp, tanpa biaya, tanpa kewajiban.</p>
            <a href="https://wa.me/6285188158542?text=Halo%20Barizaloka%2C%20saya%20ingin%20konsultasi%20website%20Toko%20Sepeda%20Listrik" target="_blank" rel="noopener" class="inline-flex items-center gap-1.5 bg-brand-dark text-white rounded-xl px-7 py-3.5 text-sm font-bold hover:bg-brand-darker transition-colors">💬 Mulai Konsultasi WhatsApp</a>
        </div>
    </section>
