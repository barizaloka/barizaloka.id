...
>
    ...
    <section class="relative overflow-hidden pt-24 pb-20 bg-gradient-to-br from-emerald-50 via-teal-50/50 to-indigo-50/40 border-b border-emerald-100/60">
        ...
        <div class="relative max-w-4xl mx-auto px-6 text-center flex flex-col items-center gap-5">
            ...
            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/90 backdrop-blur-sm border border-emerald-200 text-xs sm:text-sm font-bold text-emerald-800 shadow-sm">
                ...
                🏘️ Untuk Pemerintah Desa &amp; BUMDes
            </div>

            <h1 class="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-zinc-900 leading-tight">
                Website Desa<br>
                <span class="gradient-text-green">Transparan, Informatif, Mudah Dikelola Operator</span>
            </h1>

            <p class="text-base sm:text-lg text-zinc-600 max-w-2xl leading-relaxed">
                Bantu perangkat desa menyampaikan layanan administrasi, profil potensi desa, dan transparansi anggaran APBDes kepada warga secara terbuka dan modern.
            </p>
            ...
            <div class="flex flex-wrap items-center justify-center gap-3.5 mt-3">
                ...
                <a href="https://wa.me/6285188158542?text=Halo%20Barizaloka%2C%20saya%20ingin%20konsultasi%20website%20Desa" target="_blank" rel="noopener noreferrer" class="px-7 py-3.5 rounded-xl bg-white border border-zinc-200 text-zinc-800 font-semibold text-sm hover:bg-zinc-50 transition-all shadow-sm flex items-center gap-2">
    ...
    <section class="bg-white py-10 border-b border-zinc-100">
        <div class="max-w-5xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div class="p-4 rounded-2xl bg-emerald-50/50 border border-emerald-100">
                <div class="text-3xl font-extrabold text-emerald-700 font-brand-serif">Layanan Publik</div>
                <div class="text-xs text-zinc-600 font-medium mt-1">Syarat &amp; Alur Surat Administrasi</div>
            </div>
            <div class="p-4 rounded-2xl bg-emerald-50/50 border border-emerald-100">
                <div class="text-3xl font-extrabold text-emerald-700 font-brand-serif">Potensi Desa</div>
                <div class="text-xs text-zinc-600 font-medium mt-1">Etalase UMKM &amp; Wisata Desa</div>
            </div>
            <div class="p-4 rounded-2xl bg-emerald-50/50 border border-emerald-100">
                <div class="text-3xl font-extrabold text-emerald-700 font-brand-serif">APBDes</div>
                <div class="text-xs text-zinc-600 font-medium mt-1">Transparansi Anggaran Desa</div>
            </div>
            <div class="p-4 rounded-2xl bg-emerald-50/50 border border-emerald-100">
                <div class="text-3xl font-extrabold text-emerald-700 font-brand-serif">Domain .desa.id</div>
                <div class="text-xs text-zinc-600 font-medium mt-1">Resmi Pemerintah Republik Indonesia</div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-3xl mx-auto px-6 text-center">
            <h2 class="text-2xl font-bold text-zinc-900 font-brand-serif mb-4">Sistem Informasi Desa Modern &amp; Transparan</h2>
            <p class="text-zinc-600 leading-relaxed text-base">
                Website desa bukan cuma soal gengsi, tapi kebutuhan nyata: mempermudah warga mengurus administrasi, mempromosikan potensi desa (wisata, UMKM, produk unggulan), dan menjaga transparansi penggunaan dana desa.
            </p>
        </div>
    </section>
    ...
    <section class="py-20 bg-zinc-50 border-y border-zinc-200">
        <div class="max-w-[1100px] mx-auto px-6">
            <div class="text-center max-w-lg mx-auto mb-12">
                ...
                <h2 class="font-brand-serif text-[clamp(1.6rem,4vw,2.4rem)] font-bold mb-3 text-zinc-900">Tantangan yang Sering Dihadapi Desa</h2>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white border border-zinc-200 rounded-2xl p-8 text-center card-hover">
                    ...
                    <h3 class="font-brand-serif text-lg font-bold mb-3 text-zinc-900">Warga Bolak-balik Balai Desa</h3>
                    <p class="text-xs sm:text-sm text-zinc-600 leading-relaxed">Informasi syarat administrasi (KTP, KK, surat pengantar) tidak tersedia online sehingga warga harus datang berkali-kali.</p>
                </div>
                <div class="bg-white border border-zinc-200 rounded-2xl p-8 text-center card-hover">
                    <div class="size-16 rounded-full bg-red-50 text-red-600 flex items-center justify-center text-3xl mx-auto mb-5">🌾</div>
                    <h3 class="font-brand-serif text-lg font-bold mb-3 text-zinc-900">Potensi Desa Tidak Terekspos</h3>
                    <p class="text-xs sm:text-sm text-zinc-600 leading-relaxed">Produk UMKM dan potensi wisata desa sulit dikenal luar daerah karena tidak ada etalase digital resmi.</p>
                </div>
                <div class="bg-white border border-zinc-200 rounded-2xl p-8 text-center card-hover">
                    <div class="size-16 rounded-full bg-red-50 text-red-600 flex items-center justify-center text-3xl mx-auto mb-5">📉</div>
                    <h3 class="font-brand-serif text-lg font-bold mb-3 text-zinc-900">Transparansi Anggaran Dipertanyakan</h3>
                    <p class="text-xs sm:text-sm text-zinc-600 leading-relaxed">Warga sulit mengakses laporan penggunaan dana desa sehingga rawan menimbulkan kecurigaan.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-white">
        <div class="max-w-[1100px] mx-auto px-6">
            <div class="text-center max-w-lg mx-auto mb-12">
                ...
                <h2 class="font-brand-serif text-[clamp(1.6rem,4vw,2.4rem)] font-bold mb-3 text-zinc-900">Fitur Website Desa dari Barizaloka</h2>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="flex gap-4 bg-emerald-50/40 border border-emerald-100 rounded-2xl p-8 card-hover">
                    ...
                    <div>
                        <h3 class="font-bold text-zinc-900 text-base mb-1.5">Profil &amp; Struktur Perangkat Desa</h3>
                        <p class="text-xs sm:text-sm text-zinc-600 leading-relaxed">Tampilkan profil desa, visi misi, dan struktur perangkat desa secara lengkap dan mudah dipahami.</p>
                    </div>
                </div>
                <div class="flex gap-4 bg-emerald-50/40 border border-emerald-100 rounded-2xl p-8 card-hover">
                    <span class="text-3xl shrink-0">📄</span>
                    <div>
                        <h3 class="font-bold text-zinc-900 text-base mb-1.5">Info Layanan Administrasi</h3>
                        <p class="text-xs sm:text-sm text-zinc-600 leading-relaxed">Cantumkan syarat &amp; alur pengurusan surat-menyurat agar warga tidak perlu bolak-balik ke balai desa.</p>
                    </div>
                </div>
                <div class="flex gap-4 bg-emerald-50/40 border border-emerald-100 rounded-2xl p-8 card-hover">
                    <span class="text-3xl shrink-0">🛍️</span>
                    <div>
                        <h3 class="font-bold text-zinc-900 text-base mb-1.5">Etalase Potensi &amp; UMKM Desa</h3>
                        <p class="text-xs sm:text-sm text-zinc-600 leading-relaxed">Promosikan produk UMKM, wisata, dan potensi unggulan desa agar dikenal lebih luas.</p>
                    </div>
                </div>
                <div class="flex gap-4 bg-emerald-50/40 border border-emerald-100 rounded-2xl p-8 card-hover">
                    <span class="text-3xl shrink-0">📊</span>
                    <div>
                        <h3 class="font-bold text-zinc-900 text-base mb-1.5">Transparansi Anggaran APBDes</h3>
                        <p class="text-xs sm:text-sm text-zinc-600 leading-relaxed">Publikasikan laporan penggunaan dana desa secara berkala untuk menjaga kepercayaan warga.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="py-20 bg-zinc-50 border-t border-zinc-200" x-data="{ openFaq: 1 }">
        <div class="max-w-4xl mx-auto px-6">
            <div class="text-center max-w-lg mx-auto mb-12">
                ...
                <h2 class="font-brand-serif text-[clamp(1.6rem,4vw,2.4rem)] font-bold mb-3 text-zinc-900">Pertanyaan Seputar Website Desa</h2>
            </div>
    ...
    <section class="py-20 bg-gradient-to-br from-emerald-900 via-teal-900 to-indigo-950 text-white relative overflow-hidden">
        <div class="relative max-w-3xl mx-auto px-6 text-center flex flex-col items-center gap-6">
            ...
            <h2 class="text-3xl sm:text-4xl font-bold leading-tight font-brand-serif">
                Siap Buat Website Desa Anda?
            </h2>
            <p class="text-emerald-100/90 text-base max-w-xl">
                Konsultasi gratis via WhatsApp, tanpa biaya, tanpa kewajiban. Wujudkan transparansi informasi dan kemudahan layanan administrasi desa.
            </p>
            <a href="https://wa.me/6285188158542?text=Halo%20Barizaloka%2C%20saya%20ingin%20konsultasi%20website%20Desa" target="_blank" rel="noopener noreferrer" class="px-8 py-4 rounded-xl bg-white text-emerald-950 font-bold text-sm hover:bg-emerald-50 transition-all shadow-lg flex items-center gap-2">
