<div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-zinc-900 dark:text-zinc-100">Edit Postingan</h1>
            <p class="text-sm text-zinc-500 dark:text-zinc-400">Ubah detail dan konten artikel "{{ $post->title }}".</p>
        </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                <div class="p-6 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 space-y-4 shadow-xs">
                    ...
                    <flux:field>
                        ...
                        <flux:textarea wire:model="content" rows="12" placeholder="Tulis isi artikel..." />
                ...
                <div class="p-6 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 space-y-4 shadow-xs">
                    ...
                    @if ($featured_image)
                        <div class="relative rounded-xl overflow-hidden border border-zinc-200 dark:border-zinc-800">
                            <img src="{{ $featured_image->temporaryUrl() }}" class="w-full h-40 object-cover" alt="Preview Baru">
                        </div>
                    @elseif ($existing_image)
                        <div class="relative rounded-xl overflow-hidden border border-zinc-200 dark:border-zinc-800">
                            <img src="{{ Storage::url($existing_image) }}" class="w-full h-40 object-cover" alt="Preview">
                        </div>
                    @endif
