<div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-zinc-900 dark:text-zinc-100">Tambah Proyek Portofolio</h1>
            <p class="text-sm text-zinc-500 dark:text-zinc-400">Isi detail informasi karya / proyek website baru.</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="p-6 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 space-y-4 shadow-xs">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <flux:field>
                            ...
                            <flux:input wire:model.live="title" placeholder="Contoh: Website Profil Desa..." />
                            <flux:error name="title" />
                        </flux:field>

                        <flux:field>
                            <flux:label>Slug</flux:label>
                            <flux:input wire:model="slug" placeholder="website-profil-desa" />
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <flux:field>
                            ...
                            <flux:input wire:model="client_name" placeholder="Pemerintah Desa Rembang" />
                    ...
                    <flux:field>
                        ...
                        <flux:input wire:model="url" placeholder="https://contoh-website.id" />
                        <flux:error name="url" />
                    </flux:field>

                    <flux:field>
                        <flux:label>Ringkasan Proyek</flux:label>
                        <flux:textarea wire:model="summary" rows="3" placeholder="Deskripsi singkat mengenai proyek..." />
                        <flux:error name="summary" />
                    </flux:field>

                    <flux:field>
                        <flux:label>Deskripsi Lengkap</flux:label>
                        <flux:textarea wire:model="description" rows="8" placeholder="Penjelasan detail fitur, tantangan, dan solusi..." />
            ...
            <div class="space-y-6">
                ...
                <div class="p-6 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 space-y-4 shadow-xs">
                    ...
                    @if ($thumbnail)
                        <div class="relative rounded-xl overflow-hidden border border-zinc-200 dark:border-zinc-800">
                            <img src="{{ $thumbnail->temporaryUrl() }}" class="w-full h-40 object-cover" alt="Preview">
                        </div>
                    @endif
                ...
                <div class="flex gap-2">
                    <flux:button type="submit" variant="primary" class="w-full">Simpan Proyek</flux:button>
                </div>
            </div>
        </div>
    </form>
