<div class="max-w-2xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-zinc-900 dark:text-zinc-100">Edit FAQ</h1>
            <p class="text-sm text-zinc-500 dark:text-zinc-400">Ubah pertanyaan dan jawaban FAQ.</p>
        </div>
    ...
    <form wire:submit="save" class="p-6 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 space-y-4 shadow-xs">
        <flux:field>
            ...
            <flux:input wire:model="question" placeholder="Pertanyaan..." />
            <flux:error name="question" />
        </flux:field>

        <flux:field>
            <flux:label>Jawaban</flux:label>
            <flux:textarea wire:model="answer" rows="5" placeholder="Jawaban..." />
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <flux:field>
                ...
                <flux:input wire:model="category" placeholder="Kategori..." />
