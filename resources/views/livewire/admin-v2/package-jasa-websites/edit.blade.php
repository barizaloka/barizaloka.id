<div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-zinc-900 dark:text-zinc-100">Edit Paket Jasa Website</h1>
            <p class="text-sm text-zinc-500 dark:text-zinc-400">Ubah rincian harga dan fitur "{{ $package->name }}".</p>
        </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                <div class="p-6 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 space-y-4 shadow-xs">
                    ...
                    <flux:field>
                        ...
                        <flux:textarea wire:model="tagline" rows="2" placeholder="Tagline..." />
                    ...
                    <div class="space-y-3">
                        @foreach($features as $index => $feature)
                            <div class="flex items-center gap-3 p-3 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-800/40">
                                <div class="flex-1">
                                    <flux:input wire:model="features.{{ $index }}.text" placeholder="Fitur..." />
            ...
            <div class="space-y-6">
                <div class="p-6 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 space-y-4 shadow-xs">
                    ...
                    <flux:field>
                        ...
                        <flux:input wire:model="cta_label" placeholder="Pilih Paket" />
                        <flux:error name="cta_label" />
                    </flux:field>

                    <flux:field>
                        <flux:label>Pesan WhatsApp Default</flux:label>
                        <flux:textarea wire:model="whatsapp_message" rows="3" placeholder="Pesan..." />
                ...
                <div class="p-6 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 space-y-4 shadow-xs">
                    ...
                    <flux:field>
                        ...
                        <flux:input wire:model="badge_label" placeholder="Badge..." />
