<div class="max-w-4xl mx-auto space-y-6">
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-zinc-900 dark:text-zinc-100">Buat Popup Promo Baru</h1>
            <p class="text-sm text-zinc-500 dark:text-zinc-400">Atur konten, jadwal, dan target halaman penayangan popup.</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="p-6 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 space-y-4 shadow-xs">
                    ...
                    <flux:field>
                        ...
                        <flux:input wire:model="name" placeholder="Popup Promo Promo Kemerdekaan..." />
                ...
                <div class="p-6 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 space-y-4 shadow-xs">
                    <div class="flex items-center justify-between border-b border-zinc-200 dark:border-zinc-800 pb-3">
                        <div>
                            ...
                            <p class="text-xs text-zinc-500">Bisa lebih dari 1 slide (akan tampil sebagai carousel).</p>
                        </div>
            ...
            <div class="space-y-6">
                ...
                <div class="flex gap-2">
                    <flux:button type="submit" variant="primary" class="w-full">Simpan Popup</flux:button>
                </div>
            </div>
        </div>
    </form>
